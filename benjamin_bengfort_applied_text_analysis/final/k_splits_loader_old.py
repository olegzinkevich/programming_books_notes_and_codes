...
# Loader - Provides train/test indices to split data in train test sets. Split dataset into k consecutive folds.
...
if __name__ == '__main__':
    from corpus_reader import PickledCorpusReader
