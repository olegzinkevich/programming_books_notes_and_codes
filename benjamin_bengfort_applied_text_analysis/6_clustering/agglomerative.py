...
# hierarchy of variable-sized groups that describe document similarities at different levels
# or granularities
...
class HierarchicalTopics(object):
    ...
    def cluster(self, corpus):
        ...
        # fit_predict method, saving the resulting children and labels attributes
