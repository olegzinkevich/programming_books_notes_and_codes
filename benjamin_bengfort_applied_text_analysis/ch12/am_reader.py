...
class JsonCorpusReader(CorpusReader):
    ...
    def ids_scores_texts(self):
        ...
        for review in self.reviews():
            ...
            yield (review["id"], review["rating"], review["text"])
...
if __name__ == '__main__':
    ...
    corpus = JsonCorpusReader('C:/Users/810004/Desktop/Amazon_sample/json')
    print(list(corpus.reviews(fileids="2AVqkIhwDv8e3D1O-lebb.json")))
