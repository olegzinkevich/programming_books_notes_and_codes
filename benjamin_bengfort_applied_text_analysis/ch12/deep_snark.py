...
# Now we will write a function to build our neural network; in this case we’ll be building a long short-term memory (LSTM) network
...
# two categories for use in our train_model function. The two classes will roughly correspond
# to “liked it” or “hated it”:
def binarize(corpus):
    """
    hated it : 0.0 < y <= 3.0
    liked it : 3.0 < y <= 5.1
...
if __name__ == '__main__':
    ...
    cpath = 'C:/Users/810004/Desktop/Amazon_sample/json/am_corpus_proc'
    mpath = {
