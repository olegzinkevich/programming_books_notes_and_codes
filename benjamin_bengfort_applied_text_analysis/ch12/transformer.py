...
# look at keyphrase extractor

# # The preliminary results of our model are surprisingly effective, suggesting that keyphrase
# extraction is a useful way to reduce dimensionality for text data without totally
...
class KeyphraseExtractor(BaseEstimator, TransformerMixin):
    ...
    # !!!!!!!! - можно использовать для анализа reviews
# In particular, we will use a regular expression to define a grammar that uses the partof-
# speech tags to identify adverbial phrases (“without care”) and adjective phrases
...
# RegexpParser.
    ...
    # To further reduce complexity, we’ll add a normalize method that removes punctuation # from each tokenized, tagged sentence and lowercases the words, and a # extract_candidate_phrases that uses our grammar to extract keyphrases from each # sentence:
...
# desired number of features.
    ...
    # Finally, a clip method will ensure each document
