...
class PickledCorpusReader(CategorizedCorpusReader, CorpusReader):
    ...
    # The easiest way to handle more complex n-gram manipulation is to use the ngrams() # method from NLTK, which can be used alongside NLTK segmentation and tokenization # methods. This method will enable us to add padding before and after sentences
# such that n-grams generated also include sentence boundaries.
