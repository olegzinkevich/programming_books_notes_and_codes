...
# here the stopwords have been removed, the remaining
# features are somewhat more interesting (e.g., “game,” “season,” “team,” “world,” # “film,” “book,” “week”). However, the diffuseness of the data is also evident. # cooking
vectorizer = CountVectorizer(stop_words='english')
