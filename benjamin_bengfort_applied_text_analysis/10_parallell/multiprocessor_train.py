...
# loading a 4 GB corpus in four task processes will completely consume
# the available memory and will slow down the overall execution.
# It is common to stagger task parallel execution to avoid such
# issues, starting longer-running tasks first, then starting up faster
# tasks. This can be done with delays using sleep or process pools